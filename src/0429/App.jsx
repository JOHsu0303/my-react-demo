...
export default function App() {
    ...
    // 建立輪播圖片的陣列物件
    const slides = [
        { url: "./img0429/p1.jpg", title: "photo-1" },
        { url: "./img0429/p2.jpg", title: "photo-2" },
        { url: "./img0429/p3.jpg", title: "photo-3" },
        { url: "./img0429/p4.jpg", title: "photo-4" },
    ]


    // 當currentIndex值改變時，會觸發useEffect
    useEffect(() => {
    ...
    const Arrow = ({ direction, onClick }) => {
        return(
            ...
            <div style={{
                ...
                {
                    direction === "left" ? (
                        <FaArrowLeft size={50} onClick={onClick}  />
                    ) : (<FaArrowRight size={50} onClick={onClick}  />)
                }
            </div>    
        )
    }
